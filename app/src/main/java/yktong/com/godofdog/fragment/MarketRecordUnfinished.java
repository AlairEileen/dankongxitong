...
public class MarketRecordUnfinished extends BaseFragment {
    ...
    protected void initView() {
        ...
        commonAdapter = new CommonAdapter<MarketRecord>(marketRecordList, getActivity(), R.layout.item_market_record_unfinished) {
            @Override
