 ...
 */
public class TokerNumAddPopup extends PopupWindow {
    ...
    public TokerNumAddPopup(Context mContext, NumberListener numberListener) {

        this.view = LayoutInflater.from(mContext).inflate(R.layout.popup_toker_num_add, null);
...
//        btn_pick_photo = (Button) view.findViewById(R.id.btn_pick_photo);
        ...
        np_number = (NumberPicker) view.findViewById(R.id.np_number);
        np_number.setMinValue(1);
        np_number.setMaxValue(20);
        // 取消按钮
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                numberListener.selectNum(np_number.getValue());
                dismiss();
            }
        });
